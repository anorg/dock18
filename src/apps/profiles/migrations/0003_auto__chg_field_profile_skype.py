...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_profile', 'skype', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.skype'
        db.alter_column('profiles_profile', 'skype', self.gf('django.db.models.fields.TextField')(null=True))
