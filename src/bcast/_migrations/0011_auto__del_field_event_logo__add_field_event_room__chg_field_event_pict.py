...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bcast_event', 'picture_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True))
    ...
    models = {
        ...
        'bcast.event': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 22, 17, 3, 14, 488376)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 22, 17, 3, 14, 488344)'}),
