...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Perticipants'
        db.delete_table('bcast_perticipants')
        ...
        # Adding field 'Event.Participants'
        db.add_column('bcast_event', 'Participants', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'Perticipants'
        db.create_table('bcast_perticipants', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcast.Event'])),
            ('date_joined', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('bcast', ['Perticipants'])

        # Deleting model 'Participation'
        db.delete_table('bcast_participation')

        # Deleting field 'Event.Participants'
        db.delete_column('bcast_event', 'Participants_id')
    ...
    models = {
        ...
        'bcast.event': {
            ...
            'Participants': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 21, 17, 25, 28, 187571)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 21, 17, 25, 28, 187539)'}),
