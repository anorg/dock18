...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.chat'
        db.add_column('bcast_event', 'chat', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Event.filebrowser'
        db.add_column('bcast_event', 'filebrowser', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.chat'
        db.delete_column('bcast_event', 'chat')

        # Deleting field 'Event.filebrowser'
        db.delete_column('bcast_event', 'filebrowser')
    ...
    models = {
        ...
        'bcast.event': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 21, 10, 46, 22, 909761)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 21, 10, 46, 22, 909718)'}),
