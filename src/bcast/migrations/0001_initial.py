...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcast_event', (
            ...
            ('date_start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 9, 23, 16, 54, 19, 380290))),
            ('date_end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 9, 23, 16, 54, 19, 380340))),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('transmission', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('chat', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('filebrowser', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('type', self.gf('django.db.models.fields.CharField')(default='show', max_length=24)),
            ...
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jqchat.Room'], null=True, blank=True)),
        ))
        db.send_create_signal('bcast', ['Event'])

        # Adding model 'Participation'
        db.create_table('bcast_participation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('bcast', ['Participation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bcast_participation')
    ...
    models = {
        ...
        'bcast.event': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 23, 16, 54, 19, 380340)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 23, 16, 54, 19, 380290)'}),
