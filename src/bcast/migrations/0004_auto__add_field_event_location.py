...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bcast_event', 'location', self.gf('django.db.models.fields.CharField')(default='Dock18', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.location'
        db.delete_column('bcast_event', 'location')
    ...
    models = {
        ...
        'bcast.event': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 25, 17, 29, 35, 43171)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 25, 17, 29, 35, 43130)'}),
            'excerpt': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'filebrowser': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'location': ('django.db.models.fields.CharField', [], {'default': "'Dock18'", 'max_length': '200'}),
