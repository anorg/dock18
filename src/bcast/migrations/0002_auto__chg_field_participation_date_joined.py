...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participation.date_joined'
        db.alter_column('bcast_participation', 'date_joined', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Participation.date_joined'
        db.alter_column('bcast_participation', 'date_joined', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'bcast.event': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 25, 16, 21, 48, 462968)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 25, 16, 21, 48, 462926)'}),
