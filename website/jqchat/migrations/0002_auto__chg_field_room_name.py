...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('jqchat_room', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Room.name'
        db.alter_column('jqchat_room', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
