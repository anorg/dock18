...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ParticipantsPlugin'
        db.create_table('cmsplugin_participantsplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('limit', self.gf('django.db.models.fields.IntegerField')(default=8)),
        ))
        db.send_create_signal('bcast', ['ParticipantsPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'ParticipantsPlugin'
        db.delete_table('cmsplugin_participantsplugin')
    ...
    models = {
        ...
        'bcast.event': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 25, 16, 38, 35, 689754)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 25, 16, 38, 35, 689712)'}),
