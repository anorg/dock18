...
class Newsletter(models.Model):
    ...
    description = models.CharField(max_length=256, verbose_name=_('Description'), help_text=_('Additional Description'), blank=True, null=True)
...
class Message(models.Model):
    ...
    #newsletter = models.ManyToManyField('Newsletter', verbose_name="list of sites")
        ...
        try:
            ...
            for subscription in subscriptions:
                ...
                try:
                    ...
                    if subscription.get_recipient() not in sent:
                        message.send()
                    else:
                ...
                sent.append(subscription.get_recipient())
