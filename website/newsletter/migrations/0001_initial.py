...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('newsletter_newsletter', (
            ...
            ('subscribe_template', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='subcribe_template', to=orm['newsletter.EmailTemplate'])),
            ('unsubscribe_template', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='unsubcribe_template', to=orm['newsletter.EmailTemplate'])),
            ('update_template', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='update_template', to=orm['newsletter.EmailTemplate'])),
            ('message_template', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='message_template', to=orm['newsletter.EmailTemplate'])),
        ))
        ...
        db.create_table('newsletter_subscription', (
            ...
            ('activation_code', self.gf('django.db.models.fields.CharField')(default='50c524da1f0abdfd906c0ba596e23b6238d02597', max_length=40)),
        ...
        db.create_table('newsletter_article', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sortorder', self.gf('django.db.models.fields.PositiveIntegerField')(default=10, db_index=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ...
        db.create_table('newsletter_submission', (
            ...
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 29, 12, 35, 44, 433882), null=True, db_index=True, blank=True)),
    ...
    models = {
        ...
        'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 12, 35, 44, 433882)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'e16a43d3a867a511de9386dde676b2e682574d8e'", 'max_length': '40'}),
