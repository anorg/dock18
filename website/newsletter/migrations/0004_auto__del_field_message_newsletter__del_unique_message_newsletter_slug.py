...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Message', fields ['newsletter', 'slug']
        db.delete_unique('newsletter_message', ['newsletter_id', 'slug'])

        # Deleting field 'Message.newsletter'
        db.delete_column('newsletter_message', 'newsletter_id')

        # Adding M2M table for field newsletter on 'Message'
        db.create_table('newsletter_message_newsletter', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('message', models.ForeignKey(orm['newsletter.message'], null=False)),
            ('newsletter', models.ForeignKey(orm['newsletter.newsletter'], null=False))
        ))
        db.create_unique('newsletter_message_newsletter', ['message_id', 'newsletter_id'])


    def backwards(self, orm):
        
        # Adding field 'Message.newsletter'
        db.add_column('newsletter_message', 'newsletter', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['newsletter.Newsletter']), keep_default=False)

        # Removing M2M table for field newsletter on 'Message'
        db.delete_table('newsletter_message_newsletter')

        # Adding unique constraint on 'Message', fields ['newsletter', 'slug']
        db.create_unique('newsletter_message', ['newsletter_id', 'slug'])
    ...
    models = {
        ...
        'newsletter.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'newsletter': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['newsletter.Newsletter']", 'symmetrical': 'False'}),
        ...
        'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 45, 1, 971604)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'ee4f1bdb04a665691ff60b98a2ab4f5891ceda87'", 'max_length': '40'}),
