...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Newsletter.description'
        db.add_column('newsletter_newsletter', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Newsletter.description'
        db.delete_column('newsletter_newsletter', 'description')
    ...
    models = {
        ...
        'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 35, 19, 607698)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'4fca88d806884b6f232bc2fcf3949d172093c6c0'", 'max_length': '40'}),
